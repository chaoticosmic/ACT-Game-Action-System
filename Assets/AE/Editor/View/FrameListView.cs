   ...
   //              if (GUI.Button(btnRt, title, selected ? XMLib.AM.AEStyles.item_head_select : XMLib.AM.AEStyles.item_head_normal))
   //              {
   ...
   //              bool selected = win.actionSelectIndex == i;
   //
   //              if (GUI.Button(rt, $"{i}", selected ? XMLib.AM.AEStyles.item_head_select : XMLib.AM.AEStyles.item_head_normal))
   //              {
   //                  win.actionSelectIndex = selected ? -1 : i;
   //              }
   //          }
